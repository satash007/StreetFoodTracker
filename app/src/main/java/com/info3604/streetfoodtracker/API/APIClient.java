...
public class APIClient {
    ...
    private static Retrofit retrofit = null; //Retrofit used to capture JSON response from Google Places API

    public static final String GOOGLE_PLACE_API_KEY = "AIzaSyD2M6ScR1iUb9DIlLOmt82c_K-803WjR8g";
